...
#define DNH_FUNCAPI_DEF_(_fn) gstd::value _fn (gstd::script_machine* machine, int argc, const gstd::value* argv)
	...
	public:
		...
		static value* _value_cast(value* val, type_data::type_kind cast);
		...
		static value _cast_array(script_machine* machine, const value* argv, type_data::type_kind target, bool bSetType);
